# Notice - This project has been superseded by [Trixie.apk](https://github.com/DesktopECHO/trixie.apk)

For the latest news, updates, and disk image releases, visit the Trixie.apk repository.
