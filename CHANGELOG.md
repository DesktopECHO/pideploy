...
### Changed
- Operating environment by default: /data/data/com.desktopecho.pideploy/linux
...
- Improved command line utility pideploy
...
- Support for multiple input devices in framebuffer mode (in xorg.conf changed lines are marked as #pideploy)
...
## [1.3.4]
### Added
- Added command status to pideploy script
...
- Script pideploy can now be run from Android console
- Now can create a symbolic link to pideploy in /system/bin (Settings -> Create symlink)
